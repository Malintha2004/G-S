...
export const MobileNav: React.FC = () => {
  ...
  const menuOverlay = isOpen ? (
    <div
      ...
      className="fixed left-0 right-0 inset-x-0 top-20 bottom-0 z-[9999] w-full bg-[#0a0e13] text-on-surface overflow-y-auto border-t border-outline-variant/30 shadow-2xl p-4 sm:p-6"
  ...
  return (
    <div className="xl:hidden">
      ...
      {/* Portal overlay directly into document.body to escape header backdrop-filter containing block */}
