...
export const metadata = constructMetadata({
  title: "Commercial Metal Services | Powder Coating & Fabrication Campbellfield",
  description:
    "Explore our complete range of services: Powder Coating, Metal Fabrication, Custom Architectural Metalwork, and Industrial Finishing at G & S Engineering.",
  path: "/services",
});
    ...
    <div className="max-w-7xl mx-auto px-gutter py-space-md">
      ...
      <div className="py-space-lg mb-space-xl border-b border-outline-variant/30">
        ...
        <p className="font-body text-body-lg text-on-surface-variant max-w-3xl leading-relaxed">
          From raw steel cutting and certified welding to automated electrostatic powder coating and batch oven curing up to 8.0 metres, G & S Engineering delivers end-to-end industrial manufacturing.
        </p>
      </div>
