...
export const GALLERY_PROJECTS: GalleryProject[] = [
  {
    id: "proj-1",
    category: "industrial",
    categoryName: "Industrial Batch Bay",
    title: "Heavy Duty Structural Coating",
    subtitle: "8.0m Batch Oven Bay Electrostatic Application — Campbellfield",
    description: "Ventilated powder bay handling large structural steel elements up to 8m length.",
    image:
  ...
  },
  {
    ...
    title: "Architectural Slat Powder Coating",
    subtitle: "Electrostatic Precision Coating — Satin Black Finish",
    description: "100kV corona charge application ensuring uniform micron film coverage across slat profiles.",
    image:
  ...
  },
  {
    ...
    title: "Perforated Facade Panel Coating",
    subtitle: "Custom Colorbond Matched Powder Finish",
